...
LastEditors: zpliu
LastEditTime: 2021-01-07 15:39:46
@param: 
'''
...
def getconservedASCount(conservedASFile):
    ...
    with open(conservedASFile, 'r') as File:
        for line in File:
            ...
            out[geneid1].append(line[2])
            out[geneid2].append(line[3])
    return out
            ...
            try:
                if allAScount[geneID1] != 0 and allAScount[geneID2] != 0:
                    ...
                    out.append(geneID1+"\t"+geneID2+"\t"+str(conserveCount /
                               ...
                               "\t"+str(allAScount[geneID1])+"\t"+str(allAScount[geneID2])+"\n")
            except KeyError:
                pass
